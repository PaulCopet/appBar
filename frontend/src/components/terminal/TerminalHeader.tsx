...
function TerminalHeader({ totalSongs }: TerminalHeaderProps) {
    return (
        <header className="mb-5 border border-[#1a7a00] bg-[rgba(0,30,0,0.4)] p-4">
            <p className="mb-2 overflow-hidden whitespace-nowrap text-[11px] text-[#1a7a00]">{BORDER_LINE}</p>
            <h1 className="animate-flicker font-terminal-display text-[clamp(1.1rem,5vw,2.4rem)] tracking-[0.16em] text-[#80ff60] [text-shadow:0_0_20px_#39ff14,0_0_40px_#1a7a00]">
                ▶ ROCK_DATABASE v2.1 ▶
            </h1>
            <p className="mt-1 text-[12px] leading-relaxed text-[#1a7a00]">
